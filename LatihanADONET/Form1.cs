...
namespace LatihanADONET
{
    public partial class Form1 : Form
    {
        ...
        private SQLiteConnection GetOpenConnection()
        {
            ...
            try
            {
                string dbName = @"D:\KULIAH\Semester 3\Pemrog Lanjut Praktikum\Pertemuan 8\Module Praktikum 08 (ADO.NET)\LatihanADO.NET\Database\Dbperpustakaan.db";
                string connecString = string.Format("Data Source={0};FailMissing=True;", dbName);

                conn = new SQLiteConnection(connecString);
                conn.Open();
            }
